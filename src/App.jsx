...
export default function App() {
  ...
  // Handle Demo Anomaly Injections
  ...
  const simBtnClass = (type, activeColor) => `
    px-3 py-1 rounded-md text-xs font-medium transition-colors cursor-pointer flex items-center gap-1.5 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-400
    ${activeSimulation === type ? activeColor : 'text-slate-600 hover:text-slate-900 hover:bg-slate-100'}
  `;
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col justify-between animate-fade-in">
      ...
      {/* Top Header Bar */}
      <header className="sticky top-0 z-40 glass-header border-b border-slate-200" role="banner">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-2.5 flex items-center justify-between gap-4">
          ...
          <div className="hidden md:flex items-center gap-2 bg-slate-100/90 p-1 rounded-lg border border-slate-200" aria-label="Anomaly simulation controls">
            ...
            <button
              ...
              className={simBtnClass('tachycardia', 'bg-rose-600 text-white shadow-sm font-semibold')}
            ...
            <button
              ...
              className={simBtnClass('hypoxia', 'bg-amber-600 text-white shadow-sm font-semibold')}
            ...
            <button
              ...
              className={simBtnClass('bradycardia', 'bg-slate-800 text-white shadow-sm font-semibold')}
        ...
        <div className="md:hidden flex items-center justify-between px-4 py-2 bg-slate-100/80 border-t border-slate-200 text-xs gap-2">
